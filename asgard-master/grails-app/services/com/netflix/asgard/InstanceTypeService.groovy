...
class InstanceTypeService implements CacheInitializer {
	...
	def xl = 'Extra Large'
	def xxl = 'Double Extra Large'
	def xxxxl = 'Quadruple Extra Large'
	def xxxxxxxxl = 'Eight Extra Large'
	def gen = 'General purpose'
	def second = 'Second Generation Standard'
	def cc = 'Cluster Compute'
	def memOpt = 'Memory optimized'
	def hiMem = 'High-Memory'
	def compOpt = 'Compute optimized'
	def six4 = '64-bit'
	def three2OrSix4 = '32-bit or 64-bit'
	def hcpu
